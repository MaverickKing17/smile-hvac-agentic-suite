        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-3 pt-2">
              <a href="#" className="w-10 h-10 rounded-full border border-slate-600 flex items-center justify-center hover:bg-slate-800 hover:border-white transition-all group">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {['Services', 'Service Areas', 'Brands', 'Products', 'Coupons & Promotions', 'Reviews', 'Blog'].map((item) => (
                <li key={item}>
                  <a href="#" className="text-slate-300 hover:text-white transition-colors text-sm font-medium">{item}</a>
                </li>
              ))}
            </ul>
          </div>
